// src/billing/tax.js
// 부가세(VAT) 계산 모듈 — 실습용 "연속 코드베이스"의 핵심 파일.
//
...
//  - Day2-S4 SDD(test-first): 아래 TODO를 직접 구현 (test/tax.test.js의 skip 제거)
//
// 현재 구현은 "정상 케이스(일반 품목)"만 처리합니다. 음수 가드와 면세 분기는
// 의도적으로 비어 있습니다 — Day2-S4에서 테스트를 먼저 켜고 구현하세요.
...
export function calcVat(amount, opts = {}) {
  // TODO(Day2-S4 SDD): 음수 금액 가드 + 면세(exempt) 분기를 구현하세요.
